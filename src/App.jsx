...
function App() {
  ...
  return (
    <div className="grid grid-cols-5 h-screen text-center text-white">
     ...
     <RecentSearches recentHistory={recentHistory} clearHistory={clearHistory} setSelectedHistory={setSelectedHistory} />

      <div className="col-span-4 p-10">
        <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700 ">Hello Anilkumar, Ask me anything</h1>
        {
        loading ?
    ...
    <div role="status">
        ...
        <div ref={scrollToAnswer} className="container h-130 w-full overflow-scroll scrollbar-hide  ">
          <div className="text-zinc-400 p-2">
            {result &&
              result.map((item, index) => (
               <QuestionAnswer key={index} result={result} item={item} index={index} />
              ))}
            {/* <ul>
          {
